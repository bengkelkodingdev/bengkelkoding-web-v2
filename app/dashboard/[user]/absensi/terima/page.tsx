...
export default function TerimaAbsensiPage() {
    ...
    <>
      <div className=" overflow-x-auto">
        ...
        <div className="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center gap-5 pb-4">
          ...
          <div className="box-tolak text-white w-[15%] gap-5 p-1 rounded-md flex justify-center items-center bg-green-500 from-green-700 to-green-600 focus:ring-green-100">
        ...
        <Modal title="Keterangan Ditolak" isOpen={isKetModalOpen} onClose={handleCloseKetModal}>
            <Keterangan />
        </Modal>
