          ...
          <tbody>
            {Array.from({ length: 10 }).map((_, index) => (
              <tr key={index} className="bg-white border-b hover:bg-gray-50">
                ...
                <td className="px-6 py-4 font-semibold">Apakah bumi itu bulat?</td>
                <td className="px-6 py-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste architecto adipisci earum? Facere cupiditate odio, amet vero maxime libero magni!</td>
