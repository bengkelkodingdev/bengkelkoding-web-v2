          ...
          <tbody>
            {Array.from({ length: 10 }).map((_, index) => (
              <tr key={index} className="bg-white border-b hover:bg-gray-50">
                ...
                <td className="px-6 py-4 font-semibold">Samuel Andrey</td>
                <td className="px-6 py-4">samuel@gmail.com</td>
                <td className="px-6 py-4">
                  <p className="w-max px-4 rounded-sm text-green-600 bg-green-100">Aktif</p>
                </td>
                <td className="px-6 py-4">
