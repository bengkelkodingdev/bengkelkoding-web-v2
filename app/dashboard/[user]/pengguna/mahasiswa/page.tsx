          ...
          <tbody>
            {Array.from({ length: 10 }).map((_, index) => (
              <tr key={index} className="bg-white border-b hover:bg-gray-50">
                ...
                <td className="px-6 py-4 font-semibold">Nikolas Adi Kurniatmaja Sijabat</td>
                <td className="px-6 py-4">A11.2021.13433</td>
                <td className="px-6 py-4">111202113433@mhs.dinus.ac.id</td>
