...
const HomeDashboardLogAktivitasPage = () => {
  return (
    <>
              ...
              <tr key={index} className="bg-white border-b hover:bg-gray-50">
                ...
                <td scope="row" className="px-6 py-4 whitespace-nowrap ">
                  <div className="text-xs flex flex-col gap-1">
                    <p className="font-medium text-neutral2">Samuel Andrey</p>
                    <p className="font-normal">Admin</p>
                  </div>
                </td>
                <td className="px-6 py-4">Login</td>
                <td className="px-6 py-4">132.10.21.3</td>
                <td className="px-6 py-4">Macbook Pro</td>
                <td className="px-6 py-4">10 Desember 2023 10:20 AM</td>
              </tr>
            ))}
          </tbody>
        </table>
...
export default HomeDashboardLogAktivitasPage;
