...
const HomeDashboardKategoriKelasPage = () => {
  return (
    <>
            ...
            {Array.from({ length: 10 }).map((_, index) => (
              <tr key={index} className="bg-white border-b hover:bg-gray-50">
                ...
                <td className="px-6 py-4">
                  ...
                  Debitis eaque illo provident dignissimos sunt inventore sed
                  officiis deserunt sapiente at, veniam illum possimus
                  consequatur. Corporis voluptatum amet sit aspernatur nam.
                </td>
                <td className="px-6 py-4">
...
export default HomeDashboardKategoriKelasPage;
