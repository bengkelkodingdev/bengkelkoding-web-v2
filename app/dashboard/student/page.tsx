    ...
    <div className="grid grid-cols-2 gap-4">
      ...
      >
        ...
        <div className="flex items-start gap-4">
          <div className="w-64 max-h-64 overflow-hidden rounded-lg bg-black">
            <Image
              src={"/"}
              alt="student"
              width={500}
          ...
          <div className="flex flex-col gap-4">
            <div className="text-white">
              <h2 className="font-semibold text-2xl">Hallo, Arif Saputra !</h2>
              <p className="font-medium text-sm mt-1">A11.2021.13480</p>
        ...
        {/* Statistik Profil */}
        <div className="bg-white rounded-lg p-2 grid grid-cols-3">
          {/* Total Kelas */}
          <div className="text-center">
            <p className="font-semibold text-sm">Kelas</p>
            <div className="flex justify-center items-baseline mt-1">
              <p className="text-4xl font-semibold text-primary3">4</p>
              <svg
          ...
          <div className="text-center border-x">
            <p className="font-semibold text-sm">Sertifikat</p>
            <div className="flex justify-center items-baseline mt-1">
              <p className="text-4xl font-semibold text-primary3">3</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="18px"
                viewBox="0 -960 960 960"
          ...
          {/* Total Tugas */}
          <div className="text-center">
            <p className="font-semibold text-sm">Tugas</p>
            <div className="flex justify-center items-baseline mt-1">
              <p className="text-4xl font-semibold text-primary3">2</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="18px"
                viewBox="0 -960 960 960"
      ...
      {/* Statistik Kehadiran */}
      <div
        id="StatistikKehadiran"
        className="bg-gradient-to-r from-emerald-500 to-emerald-700 p-4 rounded-xl flex flex-col gap-4"
      >
        {/* Judul Statistik Kehadiran */}
        <div className="flex gap-2 md:gap-4 mb-4 items-center">
          <div className="h-8 w-8 bg-emerald-200 fill-emerald-500 rounded-full flex items-center justify-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="18px"
              viewBox="0 -960 960 960"
      ...
      <div id="KelasAnda">
        ...
        {/* List Kelas */}
        <div id="ListKelasAnda" className="flex flex-col gap-4">
          <div className="p-4 rounded-xl border border-neutral4 flex gap-4 items-center cursor-pointer transition-all duration-200 ease-in-out transform hover:shadow-[rgba(7,_65,_210,_0.1)_0px_9px_30px]">
            {/* Icon Kelas */}
            ...
            <div className="flex flex-col gap-2">
              <p className="text-lg font-semibold">Bengkel Koding DS-01</p>
              ...
              <p className="text-sm text-neutral2 line-clamp-2">
                ...
                Ratione, quidem! Lorem, ipsum dolor sit amet consectetur
                adipisicing elit. Ratione, quidem!
              </p>
            </div>
            {/* Nilai Akhir Kelas */}
            <div className="bg-primary5 rounded-lg min-w-24 text-center overflow-hidden">
              ...
              <strong className="block text-3xl text-primary3 py-2">-</strong>
            </div>
          </div>
        </div>
      ...
      {/* Tugas */}
      <div id="TugasAnda" className="col-span-2">
        {/* Judul Tugas */}
        <div className="flex gap-2 md:gap-4 border-b border-neutral4 mb-4 p-4 items-center">
          <div className="h-8 w-8 bg-primary5 fill-primary3 rounded-full flex items-center justify-center">
            <svg
            ...
            <div className="flex gap-6 items-center">
              ...
              <div>
                <div className="flex gap-8 items-center">
                  <div>
                    <p className="text-xl font-semibold">Penugasan 1</p>
