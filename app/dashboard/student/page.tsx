      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-md flex items-center space-x-8">
          ...
          <div className="flex-1 text-blue-900">
            ...
            <p className="font-medium text-lg">Hallo Aslam Thariq! Mulai belajar lagi, ubah ide menjadi kode.</p>
            <div className="flex justify-center items-center p-5 rounded-lg mt-4 space-x-8 bg-gradient-to-r from-[#0099FF] to-[#005C99] text-white">
              ...
              <div className="text-center relative flex-1">
                ...
                <div className="relative inline-flex items-end">
                  <h3 className="font-bold text-3xl">2</h3>
                  <svg className="w-5 h-5 text-yellow-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <div className="flex justify-between items-center">  
            ...
            <h3 className="text-sm text-white bg-primary1 p-2 rounded-lg font-semibold mb-4">Lainnya</h3>
          </div>
            ...
            {[1, 2].map((item) => (
              <div className="flex justify-between items-center">
                <div className="flex items-center">
                  ...
                  <div className="ms-2">
                    <div className="flex items-center space-x-4">
                      <p className="font-semibold text-gray-500">Penugasan 1</p>
                      <span className="text-white text-xs bg-primary1 px-2 py-0 rounded-md">Quiz</span>
                    </div>
                    <div className="flex space-x-4">
                      <div>
                        <p className="text-xs text-gray-400">Diberikan: 27 Jul 2024 23:59</p>
                        <p className="text-xs text-gray-400">Deadline: 27 Jul 2024 23:59</p>
                      </div>
                      <p className="text-xs text-gray-400">Bengkel Koding-DS01</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex space-x-4 items-center">
                  <div className="bg-blue-100 p-2 rounded-lg">
                    <p className="text-xs text-gray-400">Status</p>
                    <button className="bg-blue-100 border-slate-900 text-sm text-black px-4 py-2 rounded-lg border border-dashed">Menunggu Penilaian</button>
                  </div>
                </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mt-6">
          ...
          <div className="space-y-4">
            {[1, 2].map((item) => (
              ...
              //   <div>
              //     <h4 className="font-semibold">Bengkel Koding - DS01</h4>
              //     <p className="text-gray-500">Senin | 12:30 - 14:10 | H.6.3</p>
              //     <p className="text-sm text-gray-400">Kurikulum dirancang oleh Bengkel Koding...</p>
              //   </div>
              //   <button className="bg-blue-500 text-white px-4 py-2 rounded-lg">Masuk</button>
              // </div>
              <div className="flex justify-between items-center">
              <div className="flex items-center">
                <img
                ...
                <div className="ms-2 me-2">
                  <p className="font-semibold text-gray-500">Bengkel Koding - DS01</p>
                  <div className="flex space-x-4">
                    <div>
                      ...
                      <p className="text-xs text-gray-400">Kurikulum dirancang oleh Bengkel Koding bersama dengan pelaku industri di bidang Web Development. Siswa dipersiapkan untuk menjadi Front-End dan Back-End Web Developer sesuai dengan standar kebutuhan industri.</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="flex space-x-4 items-center">
                <div className="bg-blue-100 p-2 w-32 rounded-lg">
                  <div className="bg-blue-100 p-2 rounded-lg text-center">
                    <p className="text-xs text-gray-400 rounded-sm bg-gray-50">Nilai Akhir</p>
                    <p className="text-xs text-gray-400 mt-4 mb-4"> - </p>
                    <button className="bg-primary1 text-sm w-24 text-white px-2 py-2 rounded-lg">Masuk</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            {[1, 2].map((item) => (
              <div className="flex justify-between items-center bg-blue-100 p-2 rounded-sm">
                ...
                <div className="flex space-x-4 items-center">
                  ...
                  <button className="bg-gray-200 text-gray-500 px-4 py-2 rounded-lg">Ajukan</button>
                </div>
              </div>
            ))}
          </div>
