          ...
          <div className="flex flex-col gap-2 lg:gap-3">
            {classroom.courses.map((course) => (
              ...
              >
                ...
                <div className="absolute right-2 top-2 lg:right-4 lg:top-4 bg-primary5 text-primary3 font-semibold px-3 py-2 text-sm lg:text-base rounded-md hidden group-hover:block">
                  Lanjutkan Belajar
                </div>
              </Link>
            ))}
