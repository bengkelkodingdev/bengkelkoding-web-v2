    ...
    <div className="bg-[#f7f9fa] z-50">
      ...
      >
        <div className="flex gap-10">
          <div className="min-w-max p-4 bg-white bg-opacity-80 gap-2 rounded-md">
            <Image
          ...
          <p className="text-sm md:text-base">
            ...
            <i>Program Studi Teknik Informatika Universitas Dian Nuswantoro</i>{" "}
      ...
      <article className="max-w-5xl mx-auto mb-10 lg:mb-20 flex gap-20 justify-center">
        {statistics.map((stats, index) => (
          <div key={index} className="w-44">
            <div className="flex gap-2 items-center">
              <div className="w-10 h-10 p-1">{stats.icon}</div>
              <p className="text-2xl">{stats.data}</p>
            </div>
            <p className=" text-sm text-neutral2">{stats.label}</p>
          </div>
        ))}
      </article>
