          ...
          <div className="w-max mx-auto">
            ...
            <div className="relative ml-2">
              ...
              <input
                type="text"
                id="table-search"
                className="block w-[240px] lg:w-[300px] p-2 ps-10 border border-neutral4 rounded-md text-neutral1 focus:outline-none focus:ring-4 focus:ring-primary5 focus:border-primary1 sm:text-sm"
