...
const ContentPath = ({ selectedMenu }) => {
  ...
  return (
    <>
      ...
      {/* Path content */}
      <section className="w-full h-full flex flex-col gap-6 mt-14">
        {dataPath.data.roadmap.map((_, index) => (
          <div
            key={index}
            className="card-kursus flex flex-col md:flex-row  p-7 gap-8"
          >
            {/* Left Section */}
            <div className="flex flex-col w-full md:w-1/2 border p-3 gap-4">
            ...
            {/* Right Section */}
            <div className="flex flex-col w-full md:w-1/2 border p-3 ">
